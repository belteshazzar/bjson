...
describe('ImmutableBPlusTree', function() {
    ...
    describe('Constructor', function() {
        ...
        it('should throw error for invalid order', function() {
            expect(() => new ImmutableBPlusTree(2)).toThrow('B+ tree order must be at least 3');
            expect(() => new ImmutableBPlusTree(1)).toThrow('B+ tree order must be at least 3');
        });
    });
    ...
    describe('Add and Search', function() {
        ...
        it('should return undefined for non-existent keys', function() {
            const newTree = tree.add(10, 'ten');
            expect(newTree.search(20)).toBeUndefined();
            expect(newTree.search(5)).toBeUndefined();
        });
